...
const TopSellers = () => {
    return (
        <section className='my-7'>
            <div className="top_seller_header flex items-center justify-between mb-[5px]">
                <h2 className='text-[14px] font-medium text-black lg:text-[15px]'>e-shop Top Sellers</h2>
