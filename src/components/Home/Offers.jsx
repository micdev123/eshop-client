...
const Offers = () => {
    return (
        <section className='mb-6 hidden lg:block'>
            <div className="offers flex items-center justify-between px-8">
                <div className="offer flex items-center">
                    ...
                    <div className="basic_text">
                        ...
                        <p className="text-[10px] text-lightBlack">For all order over $100</p>
                    </div>
                </div>
                ...
                <div className="offer flex items-center">
                    ...
                    <div className="basic_text">
                        ...
                        <p className="text-[10px] text-lightBlack">Shop with an expert</p>
                    </div>
                </div>
                ...
                <div className="offer flex items-center">
                    ...
                    <div className="basic_text">
                        ...
                        <p className="text-[10px] text-lightBlack">Get factory direct price</p>
                    </div>
                </div>
                ...
                <div className="offer flex items-center">
                    ...
                    <div className="basic_text">
                        ...
                        <p className="text-[10px] text-lightBlack">save up to 25% off</p>
                    </div>
                </div>
                ...
                <div className="offer flex items-center">
                    ...
                    <div className="basic_text">
                        ...
                        <p className="text-[10px] text-lightBlack">100% protected payment</p>
                    </div>
                </div>
            </div>
        </section>
