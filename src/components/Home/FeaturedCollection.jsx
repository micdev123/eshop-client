...
const FeaturedCollection = () => {
    return (
        <section className='my-7'>
            <div className="collection_header flex items-center justify-between mb-[5px]">
                <h2 className='text-[14px] font-medium text-black lg:text-[15px]'>Featured Collection</h2>
                <div className="navigation flex items-center">
                    <BiLeftArrowCircle className='text-[1.1rem] mr-2' />
                    <BiRightArrowCircle className='text-[1.1rem]' />
                </div>
            </div>
            <div className="collection flex gap-2">
